...
export default async function JobsPage({ searchParams }: PageProps) {
  ...
  if (scan) {
    ...
    // Two-step search: first find customers matching the query, then include their jobs
